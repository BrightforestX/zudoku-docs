...
Then(
  "the script should check for XAI_API_KEY before running",
  async function () {
...
Then(
  "the image should be saved to docs/public/images/brightpath-ai/hero.png",
  async function () {
...
Then("{word}/hero.png should exist", async (domain) => {
...
Then(
  "the brightpath-ai image should have AI/neural pathway theme",
  function () {
...
Then(
  "the figmatofullstack-com image should have design-to-code theme",
  function () {
...
Then(
  "each image should have a dark background with accent colors",
  function () {
    // Check that prompts mention dark background
    const darkBackgroundCount = (
      this.scriptContent.match(/dark background/gi) || []
    ).length;
