...
DOMAINS=(
    ...
    ["pathx-ai"]="Professional algorithm optimization dashboard with performance metrics, hyperparameter tuning visualizations, and benchmark comparison graphs. Futuristic tech aesthetic with flowing data streams, optimization pathways, and upward trending performance curves. Dark navy background with vibrant orange and electric blue accents, gradient lighting effects, clean modern design"
