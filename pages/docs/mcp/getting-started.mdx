...
Claude Desktop has built-in MCP support. Add BrightForest agents to your `claude_desktop_config.json`:
...
All BrightForest MCP servers require authentication via API key. You can generate API keys from your [BrightForest Dashboard](https://app.brightforest.io/settings/api-keys).
