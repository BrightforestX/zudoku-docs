...
```text
Tune learning rate (1e-5 to 1e-2) and batch size (8, 16, 32) for my image classifier,
...
```text
Profile my data preprocessing pipeline, identify memory bottlenecks, and suggest
