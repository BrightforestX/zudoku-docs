...
<Tabs>
  ...
  <Tab title="Learning Path">
    ``` Create a 6-month learning path to become an NLP engineer. I know Python and basic ML, want
    to master transformers and LLMs. ```
  </Tab>
  <Tab title="Project Guidance">
    ``` Guide me through building a sentiment analysis API. I'm at the data collection stage, using
    PyTorch and FastAPI. ```
  </Tab>
</Tabs>
